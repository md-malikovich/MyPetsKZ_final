package com.e.mypetskz.main.kennel;
...
public class KennelActivity extends AppCompatActivity {
    ...
    private void initViews() {
        fab_home = findViewById(R.id.fab_home_kennelA);
        fab_home.setOnClickListener(new FabHomeClickListener());
        webView = findViewById(R.id.webView_kennelA);
    }

    @SuppressLint("SetJavaScriptEnabled")
    public void initWeb() {
        final ConnectivityManager connMgr = (ConnectivityManager) KennelActivity.this
        ...
        if (wifi.isConnected() || mobile.isConnected()) {
            ...
            webView.loadUrl("http://mypets.kz/breeder-list/");
            webView.setWebViewClient(new WebViewClient());
        }else{
            startActivity(new Intent(KennelActivity.this, NoInternetActivity.class));
        }
    }
}